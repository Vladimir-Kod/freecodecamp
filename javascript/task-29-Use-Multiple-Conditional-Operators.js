...
// In the checkSign function, use multiple conditional operators - following the 
// recommended format used in findGreaterOrEqual - to check if a number is positive, 
